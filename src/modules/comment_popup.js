...
const displayPopup = (data) => {
  Swal.fire({
    ...
    <textarea id="comment" type="text" placeholder= "Your insight" required rows="4" cols="50"> </textarea><br><br>
    <input type="submit" class="submit comment-button" value='comment'/>
    </form>
    </div>`,
